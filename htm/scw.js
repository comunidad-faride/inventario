    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// Espa�ol
             scwToday               = 'Hoy:';
             scwClear               = 'Limpiar';
             scwDrag                = 'click aqui para arrastrar';
             scwArrMonthNames       = ['Ene','Feb','Mar','Abr','May','Jun',
                                       'Jul','Ago','Sep','Oct','Nov','Dic'];
             scwArrWeekInits        = ['D','L','M','X','J','V','S'];
             scwInvalidDateMsg      = 'The entered date is invalid.\n';
             scwOutOfRangeMsg       = 'La fecha ingresada estᠦuera de rango.';
             scwDoesNotExistMsg     = 'La fecha ingresada no existe.';
             scwInvalidAlert        = ['Fecha invalida (',') ignorada.'];
             scwDateDisablingError  = ['Error ',' no es un objeto Date.'];
             scwRangeDisablingError = ['Error ',
                                       ' debe consistir de dos elementos.'];
            }
        };
...
// ***************************
    ...
    document.write(
     "<iframe class='scw' " + (scwID('scwIElt7')?"src='../htm/scwblank.html '":'') +
