...
<!--	ARCHIVOS JAVASCRIPT   -->	
	...
	//xajax_asignarConXajax("contenedor", "innerHTML", "CLS_USUARIO", "frmLogin");//	FUNCIONA EXCELENTE  ..		//xajax_asignarConXajax("contenedor", "innerHTML", "CLS_USUARIO", "frmCambioClave");
	...
	//xajax_asignarConXajax("contenedor", "innerHTML", "CLS_VENTAS", "frmVentas");
	//xajax_asignarConXajax("contenedor", "innerHTML", "CLS_REPORTES", "frmReportesInventario");
	xajax_asignarConXajax("contenedor", "innerHTML", "CLS_TBLTIENDAS", "resumenTienda", 1);
	</script>
