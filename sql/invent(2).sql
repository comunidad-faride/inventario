...
--
-- Servidor: localhost
-- Tiempo de generación: 05-12-2017 a las 11:43:54
...
--
-- Volcado de datos para la tabla `tblcontrolingresos`
--

INSERT INTO `tblcontrolingresos` (`idcontrol`, `idtblTienda`, `fecha`, `comentario`) VALUES
(1, 1, '2017-12-04', '');
...
CREATE TABLE IF NOT EXISTS `tblingresos` (
  ...
  `idcontrol` int(10) unsigned NOT NULL,
  `montoIngreso` decimal(12,2) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `tblingresos`
--

INSERT INTO `tblingresos` (`idingresos`, `idBanco`, `idtipomovimiento`, `idcontrol`, `montoIngreso`) VALUES
(1, 1, 2, 1, '12.00'),
(2, 1, 4, 1, '23.00'),
(3, 1, 1, 1, '34.00'),
(4, 1, 5, 1, '45.00'),
