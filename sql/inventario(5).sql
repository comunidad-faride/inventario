...
--
-- Servidor: localhost
-- Tiempo de generación: 23-11-2017 a las 15:35:32
...
(33, 10, 3, -16, '13900.00'),
(34, 11, 4, -15, '20000.00'),
(35, 12, 1, -12, '1200000.00'),
(36, 13, 1, 20, '124000.00');
...
(1, 1, '2017-11-01', 176, 0, 1, ''),
(2, 1, '2017-11-02', 177, 0, 1, ''),
(3, 1, '2017-11-03', 178, 0, 1, ''),
(4, 4, '2017-11-04', 1, 0, 1, ''),
(5, 4, '2017-11-04', 1, 0, 1, ''),
(6, 3, '2017-11-04', 1, 1, 1, ''),
(7, 3, '2017-11-15', 2, 1, 1, ''),
(8, 1, '2017-11-15', 1, 1, 1, ''),
(9, 4, '2017-11-15', 2, 0, 1, ''),
(10, 1, '2017-11-19', 2, 1, 4, ''),
(11, 4, '2017-11-19', 1, 1, 2, ''),
(12, 1, '2017-11-23', 3, 1, 1, ''),
(13, 1, '2017-11-23', 179, 0, 1, '');
...
INSERT INTO `tblpagos` (`idPago`, `idFactura`, `fecha`, `referencia`, `monto`, `confirmado`) VALUES
(1, 10, '2017-11-20', '', '222400.00', 'N');
...
(5, 'Otra mas', 'El gue', 'la de la casa', '98876543222');
...
ALTER TABLE `tblcontrolfisico`
  ...
  ADD CONSTRAINT `tblcontrolfisico_ibfk_2` FOREIGN KEY (`idTipoControl`) REFERENCES `tbltipocontrol` (`idTipoControl`);
...
ALTER TABLE `tblfacturas`
  ...
  ADD CONSTRAINT `tblfacturas_ibfk_4` FOREIGN KEY (`idFormaPago`) REFERENCES `tblformaspago` (`idFormaPago`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tblpagos`
  ADD CONSTRAINT `tblpagos_ibfk_1` FOREIGN KEY (`idFactura`) REFERENCES `tblfacturas` (`idFactura`) ON UPDATE CASCADE;
