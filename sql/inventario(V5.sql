...
--
-- Servidor: localhost
-- Tiempo de generación: 18-11-2017 a las 17:02:39
...
CREATE TABLE IF NOT EXISTS `tblfacturas` (
  ...
  `idOpciones` tinyint(2) unsigned NOT NULL COMMENT 'V para ventas y E para entregas',
...
INSERT INTO `tblfacturas` (`idFactura`, `idtblTienda`, `fecha`, `numFactura`, `idOpciones`, `formaPago`, `comentario`) VALUES
(1, 1, '2017-11-01', 176, 0, 0, ''),
(2, 1, '2017-11-02', 177, 0, 0, ''),
(3, 1, '2017-11-03', 178, 0, 0, ''),
(4, 4, '2017-11-04', 1, 0, 0, ''),
(5, 4, '2017-11-04', 1, 0, 0, ''),
(6, 3, '2017-11-04', 1, 0, 0, ''),
(7, 3, '2017-11-15', 2, 0, 0, ''),
(8, 1, '2017-11-15', 1, 0, 0, ''),
(9, 4, '2017-11-15', 2, 0, 0, '');
...
ALTER TABLE `tblfacturas`
  ADD CONSTRAINT `tblfactuas_tblopciones` FOREIGN KEY (`idOpciones`) REFERENCES `tblopciones` (`idOpciones`),
